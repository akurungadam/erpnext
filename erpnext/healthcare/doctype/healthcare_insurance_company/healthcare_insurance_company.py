...
def create_customer(doc):
    customer_group = frappe.db.exists('Customer Group', {'customer_group_name': 'Healthcare Insurance Company'})
    ...
    customer.territory = frappe.get_value('Selling Settings', None, 'territory') or 'All Territories'
